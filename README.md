...
| 필드명 | 타입 | 설명 | 예시 |
|--------|------|------|------|
| **submission_id** | string | 제출 고유 ID | `s788328261` |
| **problem_id** | string | 문제 고유 ID | `p02642` |
| **text** | string | 원본 소스코드 | 전체 코드 텍스트 |
| **code_sha1** | string | 원본 코드 SHA1 해시 | `908a294c00426a1d8b56a6026b345a93050ce9c6` |
| **code_bytes** | integer | 원본 코드 바이트 수 | `3150` |
| **language** | string | 프로그래밍 언어 | `Python` |
| **status** | string | 채점 결과 | `Wrong Answer` |
| **date** | integer | 제출 일시 (Unix timestamp) | `1592189032` |
| **user_id** | string | 사용자 고유 ID | `u509739538` |
| **n_chars** | integer | 원본 코드 문자 수 | `3102` |
| **n_lines** | integer | 원본 코드 줄 수 | `185` |
| **text_norm** | string | 정규화된 소스코드 | 전처리 후 코드 |
| **text_norm_sha1** | string | 정규화 코드 SHA1 해시 | `3664b2a69364090aeb099de41e00987648be7c29` |
| **n_chars_norm** | integer | 정규화 코드 문자 수 | `3908` |
| **n_lines_norm** | integer | 정규화 코드 줄 수 | `206` |
